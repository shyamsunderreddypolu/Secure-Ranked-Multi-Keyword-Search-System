...
* **Cloud Server:** Hosts raw binary ciphertexts and secure metadata index vectors, executes search procedures homomorphically, and manages user accounts.
...
![Landing Page](https://raw.githubusercontent.com/shyamsunderreddypolu/Secure-Ranked-Multi-Keyword-Search-System/main/images/screenshots/landing_page.png)

### 🖼️ Split-Screen Login
...
![Login Portal](https://raw.githubusercontent.com/shyamsunderreddypolu/Secure-Ranked-Multi-Keyword-Search-System/main/images/screenshots/login.png)

### 🖼️ Data Owner Dashboard
*Main monitoring hub for Data Owners showing file statistics, uploads, and action menus.*
![DO Dashboard](https://raw.githubusercontent.com/shyamsunderreddypolu/Secure-Ranked-Multi-Keyword-Search-System/main/images/screenshots/do_dashboard.png)

### 🖼️ Drag-and-Drop File Upload
*An upload portal displaying a dropzone, size validations, and client-side encryption step indicators.*
![File Upload](https://raw.githubusercontent.com/shyamsunderreddypolu/Secure-Ranked-Multi-Keyword-Search-System/main/images/screenshots/file_upload.png)

### 🖼️ Asynchronous Search Page
*Multi-keyword search console allowing data consumers to input terms, add chips, and submit queries.*
![Search Console](https://raw.githubusercontent.com/shyamsunderreddypolu/Secure-Ranked-Multi-Keyword-Search-System/main/images/screenshots/search_page.png)

### 🖼️ Search Results
*Relevance-ranked query matches returned within encrypted domains, featuring verification tags.*
![Search Results](https://raw.githubusercontent.com/shyamsunderreddypolu/Secure-Ranked-Multi-Keyword-Search-System/main/images/screenshots/search_results.png)

### 🖼️ PKG Dashboard
*Management panel for the Private Key Generator admin, handling key requests and distributing system parameters.*
![PKG Dashboard](https://raw.githubusercontent.com/shyamsunderreddypolu/Secure-Ranked-Multi-Keyword-Search-System/main/images/screenshots/pkg_dashboard.png)

### 🖼️ Cloud Server Dashboard
*Administrative console tracking files, user statuses, and security audits.*
![Cloud Server Dashboard](https://raw.githubusercontent.com/shyamsunderreddypolu/Secure-Ranked-Multi-Keyword-Search-System/main/images/screenshots/cloud_dashboard.png)
